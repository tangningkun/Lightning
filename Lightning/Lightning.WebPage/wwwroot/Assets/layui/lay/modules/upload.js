  ...
  (p.prototype.config = {
    ...
    (p.prototype.file = function() {
      var e = this,
        t = e.config,
        n = (e.elemFile = i(
          ['<input class="' + u + '" type="file" accept="' + t.acceptMime + '" name="' + t.field + '"', t.multiple ? ' multiple' : '', '>'].join('')
        )),
        o = t.elem.next();
    ...
    (p.prototype.initIE = function() {
      var e = this,
        ...
        a = i(
          [
            '<form target="' + f + '" class="' + c + '" method="' + t.method,
            '" key="set-mine" enctype="multipart/form-data" action="' + t.url + '">',
            '</form>'
          ].join('')
        );
